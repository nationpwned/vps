...
read -s -p "Enter a password for Hysteria2 (example @InibapakBudi2025): " HYSTERIA_PASSWORD
echo
read -s -p "Enter a password for obfuscation (optional, press Enter to skip) (example @IniibuBudi2025): " OBFS_PASSWORD
echo
